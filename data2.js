...
const GasData = () => {
    ...
    const fetchData = () => {
        fetch("http://localhost:8081/dh11/api2.php")
            .then(res => res.json())
            .then(
                (result) => {
                    console.log(result);
    ...
    return (
        <div className="container mt-4">
            <div className="container mt-4 d-flex justify-content-center align-items-center flex-column">
                <h1 className="text-uppercase "style={{ fontFamily: 'Roboto, sans-serif', fontSize: '2.5em', marginBottom: '0' }}>Table View - MQ15 Sensor</h1>
                ...
                <table className="table table-bordered custom-table">
                    <thead className="custom-thead">
                        <tr  className="labelColor">
                            ...
                            <th  className="labelColor">Gas Level</th>
